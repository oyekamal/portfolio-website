...
const Hero = ({ personal, social }) => {
    ...
    useEffect(() => {
        ...
        if (typing) {
            if (i < full.length) {
                const t = setTimeout(() => setDisplayed(full.slice(0, i + 1)), 55);
            ...
            if (i > 0) {
                const t = setTimeout(() => setDisplayed(full.slice(0, i - 1)), 28);
                return () => clearTimeout(t);
            } else {
            ...
            <div className="container">
                <div className="hero-content">
                    <div className="hero-text">
                        <p className="hero-greeting">Based in Islamabad, Pakistan</p>
